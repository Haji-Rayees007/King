...
* `git clone https://github.com/Haji-Rayees007/King.git`
* `cd king`
...
## Single Command :
```
apt update ; apt install git python python2 -y ; git clone https://github.com/Haji-Rayees007/King.git
```
...
## Find Me on :
[![Github](https://img.shields.io/badge/Github-HTR--TECH-green?style=for-the-badge&logo=github)](https://github.com/htr-tech/afgcrack.git)